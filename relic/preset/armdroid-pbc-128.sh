...
cmake -DWITH="DV;BN;MD;FP;EP;FPX;EPX;PP;PC" -DRELIC_CHECK=off -DARITH=arm-asm-254 -DARCH=ARM -DCOLOR=off -DOPSYS=DROID -DFP_PRIME=254 -DFP_QNRES=on -DFP_METHD="INTEG;INTEG;INTEG;MONTY;EXGCD;SLIDE" -DFPX_METHD="INTEG;INTEG;LAZYR" -DPP_METHD="LAZYR;OATEP" -DCOMP="-O3 -funroll-loops -fomit-frame-pointer -I/opt/android-ndk/platforms/android-14/arch-arm/usr/include" -DLINK="-L/opt/android-ndk/platforms/android-14/arch-arm/usr/lib/ -llog" -DTIMER=HREAL -DWORD=32 -DSTLIB=on -DSHLIB=off $1
